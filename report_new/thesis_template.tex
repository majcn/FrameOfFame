...
\begin{lstlisting}[style=XML, label=lst:haar_frontal_face, caption=Izsek iz datoteke harrcascade\_frontalface\_default.xml]
...
\begin{lstlisting}[style=XML, label=lst:haar_eye, caption=Izsek iz datoteke harrcascade\_eye.xml]
