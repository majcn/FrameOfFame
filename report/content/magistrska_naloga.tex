...
\chapter{15 sekund slave}
``15 sekund slave'' je interaktivna umetniška instalacija, ki obraz naključno
izbranega obiskovalca galerije povzdigne v umetniški objekt za petnajst sekund.
Instalacija je bila navdahnjena s slavnim citatom Andyja Warhola: ``V
prihodnosti bodo vsi ljudje doživeli svojih petnajst minut
slave''~\footnote{Originalno angl.: \textit{In the future everybody will be
world famous for fifteen minutes}} kot tudi z njegovim načinom predelave
obrazov v slogu pop-art~\cite{15secSlo}.


\chapter{Obdelava slik}
Instalacija ``15 sekund slave'' vsebuje 17 različnih
filtrov~\cite[Poglavje~5]{thesisSamoJuvan} za obdelavo prejetih slik v pop-
