...
Andy Warhol~\cite{wiki:AndyWarhol} se je rodil 6.8.1928 v Pittsburgu v Pensilvaniji staršema
Slovakoma. Njegovo otroštvo je bilo zelo težko, saj je v času velike
gospodarske krize oče ostal brez službe. Kljub temu je po osnovnem šolanju
obiskoval tečaj komercialnega oblikovanja na Carnegijevem inštitutu za
...
slikar, vendar pa je hrepenel po umetniški slavi. Po številnih neuspehih se mu je leta 1964 pri razstavi Ameriški Supermarket le odprlo. Ta razstava je bila ena izmed prvih, ki je javnost soočala s pop artom. Nato je šlo samo še navzgor.

Njegove najbolj znane slike so Dick Tracy, Plesna shema (tango), Coca-Cola, Pločevinka juhe Campbell, Zvitek bankovcev, Marilyn Monroe (prikazana na sliki~\ref{fig:art-marilyn}),...
