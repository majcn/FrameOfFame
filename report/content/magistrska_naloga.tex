...
datoteki \textit{harrcascade\_frontalface\_default.xml}, s katero smo dobili
rezultate obrazov. Ker je že sama klasifikacija obraza porabila kar nekaj
dragocenega časa, smo se odločili, da iskanje prekinemo po prvem kandidatu
obraza, ki je velik vsaj ena desetina celotne slike.
...
uporabili lastnosti, zapisane v datoteki \textit{harrcascade\_eye.xml}. V
primeru, če smo našli točno dva rezultata smo vrnili prejšnji rezultat, v
nasprotnem primeru pa, da obraz ni najden.
