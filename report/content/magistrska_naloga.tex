...
povezavo z Graph API-jem. Z Graph API-jem lahko uporabljamo na več načinov.
Najbolj osnoven je preko HTTP protokola, a hkrati najbolj zahteven za
implementacijo. Drugi način je preko knjižnice, prilagojeno za Android
naprave. S to knjižico lahko na enostaven način opravimo vse osnovne akcije,
kot so prijava v sistem in objavljanje slike.
