...
obrazov}.}. Ta slika (primer lahko vidimo na sliki~\ref{fig:FoF-lena}) je
končni prikaz naše nove instalacije.

\begin{figure}[!ht]
    \centering
    \includegraphics[width=\textwidth]{FoF-lena-40x40}
    \caption{TODO: SCREENSHOT Prikaz iz 1600 istih, a hkrati različnih obrazov.}
    \label{fig:FoF-lena}
\end{figure}
