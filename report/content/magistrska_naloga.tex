...
\begin{itemize}
    \item \textbf{uravnovešenje barv} \textit{angl. color balance} \hfill \\
...
Uravnovešenje barv se računa v barvnem prostoru RGB. Računamo jo za vsako
...
Po izračunanih vrednosti dane rezultate v RGB prostoru prenesemo v HSL
prostor.

Od tukaj naprej se način računanja za barvo malo spremeni.

Ker se GIMP uspešno še naprej razvija, se je posledično tudi implementacija
teh filtrov rahlo spremenila.
