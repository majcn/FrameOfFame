...
Pločevinka juhe Campbell, Zvitek bankovcev in serija portretov znanih
...
\begin{figure}[!ht]
    ...
    \caption{Popart slika umetnika Andyja Warhola~\ref{andyExhibitionMonroe}}
...
Splošno gledano obstajata dve strategiji za ohranjanje digitalne umetnosti:
\begin{itemize}
\item
...
Samsnug Galaxy S5 se ponaša s štirijedrnim procesorjem 2.5GHz Krait 400 na
...
ima šestnajst megapikslov in lahko torej naredi sliko v velikosti 5312~x~2988
...
Iz teh treh filtrov je bilo narejenih mnogo kombinacij, v končni fazi pa izbranih le 17 tistih, ki so bile najprimernejše. Ostale so bile izločene, ker rezultati niso bili dovolj dobri, pri nekaterih pa je bila prevelika časovna zahtevnost~\cite{thesisSamoJuvan}.
...
bolj popularno, je integracija s socialnimi omrežji, kar je podrobneje opisano v \ref{ch:socialNetwork}. poglavju.
...
s starim zaslonom LCD, poleg tega pa je tak format uporabljal tudi Andy Warhol. Večina današnjih zaslonov LCD je formata 16:9 ali pa še
...
je kmalu rodila ideja o še širšem zaslonu, takem, pri katerem je širina malo več kot
enkrat daljša od višine, kot je prikazano na sliki~\ref{fig:frame2}. S tem smo
omogočili možnost prikazovanja dveh slik vzporedno -- kot da bi naenkrat
imeli razstavljeni dve različici istega portreta. Na podoben način je svoje
popart portrete razstavljal tudi Andy Warhol. Seveda ima vsaka slika drug
...
smo vse skupaj malo poenostavili in uporabili kar iste obraze, vendar
...
pokazala popart slika, ki je njen umetniški ``selfi'', in če želi, je ta pop-
art slika lahko kmalu javno objavljena na enem izmed socialnih omrežij, kar lahko naredi tako,  da se na primer dotakne ikone in tako odloči, da se njegov portret prenese na želeno socialno omrežje.
...
\begin{itemize}
    ...
    \item sestavljanje končnega obraza iz več obrazov, ki so obdelani z različnimi filtri. Idejo za to smo dobili na podlagi oglasa prve implementacije;
