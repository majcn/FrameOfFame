...
pravice želimo, da jih naša aplikacija uporablja. Več pravic, ki jih bomo
...
Ko je aplikacija narejena in potrjena, dobimo poseben ključ, ki je potreben za povezavo z Graph API-jem. Z Graph API-jem lahko uporabljamo na več načinov. Najbolj osnoven je preko HTTP protokola, a hkrati najbolj zahteven za implementacijo. Drugi način je preko knjižnice, prilagojeno za Android naprave. S to knjižico lahko na enostaven način opravimo vse osnovne akcije, kot so prijava v sistem in objavljanje slike.
