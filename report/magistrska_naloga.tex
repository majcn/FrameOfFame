...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\ttitle}{Vzorec magistrskega dela}
\newcommand{\ttitleEn}{Masters thesis sample}
\newcommand{\tsubject}{\ttitle}
\newcommand{\tsubjectEn}{\ttitleEn}
\newcommand{\tauthor}{Gašper Fijavž}
...
\hypersetup{pdfauthor={\tauthor, gasper.fijavz@fri.uni-lj.si}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\def\Title{\ttitle}
\def\Author{\tauthor, gasper.fijavz@fri.uni-lj.si}
\def\Subject{\ttitleEn}
...
%naslovnica
 \thispagestyle{empty}%
   \begin{center}
    ...
    {\titfont Vzorec magistrskega dela \par}%
...
informatiko ter mentorja\footnote{V dogovorju z mentorjem lahko kandidat magistrsko delo s pripadajočo izvorno kodo izda tudi pod drugo licenco, ki ponuja določen del pravic vsem: npr. Creative Commons, GNU GPL. V tem primeru na to mesto vstavite opis licence, na primer tekst \cite{licence}.}.}
